/*$Id: lang_spice.cc,v 1.2 2010-09-22 13:19:50 felix Exp $ -*- C++ -*-
 * vim:ts=8:sw=2:et
 * Copyright (C) 2006 Albert Davis
 * Author: Albert Davis <aldavis@gnu.org>
 * Modified by: Rishabh Yadav <rishabh.ece.iitbhu@gmail.com> on 2013-08-10 0:30:00
...
DISPATCHER<CMD>::INSTALL d5(&command_dispatcher, "< | run", &p5);
/*--------------------------------------------------------------------------*/
/* cmd_get: get command
...
DISPATCHER<CMD>::INSTALL d6(&command_dispatcher, ".get|get|source", &p6);
/*--------------------------------------------------------------------------*/
...
DISPATCHER<CMD>::INSTALL d7(&command_dispatcher, ".build|build|circbyline", &p7);
/*--------------------------------------------------------------------------*/
